      ...
      {published.map((post) => (
        ...
        >
          <div className="flex items-baseline justify-between gap-4">
            <h3 className="text-lg font-semibold text-gray-900 group-hover:text-emerald-700 dark:text-white dark:group-hover:text-emerald-400">
              {post.title}
            </h3>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-gray-600 dark:text-white/70">
            {post.description}
          </p>
        </Link>
      ))}
      <p className="pt-2 text-sm text-gray-600 dark:text-white/60">
