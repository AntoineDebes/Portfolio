...
export const metadata: Metadata = {
  title: "Writing",
  description:
    "Articles on web performance, Next.js, React, and Core Web Vitals by Antoine Debes.",
  ...
  return (
    <div className="mx-auto min-h-svh max-w-3xl px-6 py-14">
      ...
      <main id="content">
        ...
        <p className="mt-3 max-w-xl text-sm leading-relaxed text-gray-600 dark:text-white/65">
            ...
            <li key={post.slug}>
              ...
              >
                <div className="flex flex-wrap items-baseline justify-between gap-2">
                  <h2 className="text-xl font-semibold text-gray-900 group-hover:text-emerald-700 dark:text-white dark:group-hover:text-emerald-400">
                    {post.title}
                  </h2>
                  <span className="font-mono text-xs text-gray-500 tabular-nums dark:text-white/50">
                    {formatDate(post.date)} · {post.metadata.readingTime} min
                  </span>
                </div>
                <p className="mt-3 max-w-2xl text-sm leading-relaxed text-gray-600 dark:text-white/70">
                  {post.description}
                </p>
              </Link>
            </li>
